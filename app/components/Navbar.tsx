    ...
    <div className="relative">
      ...
      <header className="fixed md:sticky top-0 z-50 w-full bg-slate-900 border-b border-slate-800">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <Link
            href="/"
            className="flex items-center gap-2 px-4 py-2 text-base font-semibold tracking-wide text-slate-200 border border-slate-600 rounded-md bg-slate-800 hover:bg-slate-700 hover:text-capri hover:scale-105 transition-transform"
          >
            <Image
              src={roxAvatar}
              alt="rox_k avatar"
